...
export const TYPES = {
  ...
  receivable: {
    ...
    fields: ["name", "category", "counterparty", "amount", "currency", "date", "dueDate", "status", "priority", "terms", "owner", "source", "confidence", "reminderDate", "linked", "details"],
  ...
  payable: {
    ...
    fields: ["name", "category", "counterparty", "amount", "currency", "date", "dueDate", "status", "priority", "terms", "rate", "owner", "source", "confidence", "reminderDate", "linked", "details"],
  ...
  income: {
    ...
    fields: ["name", "category", "counterparty", "amount", "currency", "date", "status", "owner", "recurrence", "source", "confidence", "linked", "details"],
  ...
  investment: {
    ...
    fields: ["name", "category", "counterparty", "amount", "costBasis", "currency", "date", "status", "priority", "terms", "owner", "source", "confidence", "reminderDate", "linked", "details"],
  ...
  asset: {
    ...
    fields: ["name", "category", "counterparty", "amount", "costBasis", "currency", "date", "status", "ownershipPercent", "owner", "source", "confidence", "reminderDate", "linked", "details"],
