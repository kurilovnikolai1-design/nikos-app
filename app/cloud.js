...
import { t, getLocale } from "./i18n.js?v=20260827-122205";
import * as store from "./store.js?v=20260827-122205";
import { migrateRecord } from "./records.js?v=20260827-122205";
...
function loadLibrary() {
  ...
  libraryPromise = new Promise((resolve, reject) => {
    ...
    script.src = "vendor/supabase.js?v=20260827-122205";
    script.async = true;
