...
import { t, getLocale } from "./i18n.js?v=20260828-003727";
import * as store from "./store.js?v=20260828-003727";
import { migrateRecord } from "./records.js?v=20260828-003727";
...
function loadLibrary() {
  ...
  libraryPromise = new Promise((resolve, reject) => {
    ...
    script.src = "vendor/supabase.js?v=20260828-003727";
    script.async = true;
