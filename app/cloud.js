...
import { t, getLocale } from "./i18n.js?v=20260828-004404";
import * as store from "./store.js?v=20260828-004404";
import { migrateRecord } from "./records.js?v=20260828-004404";
...
function loadLibrary() {
  ...
  libraryPromise = new Promise((resolve, reject) => {
    ...
    script.src = "vendor/supabase.js?v=20260828-004404";
    script.async = true;
