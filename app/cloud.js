...
import { t, getLocale } from "./i18n.js?v=20260827-144942";
import * as store from "./store.js?v=20260827-144942";
import { migrateRecord } from "./records.js?v=20260827-144942";
...
function loadLibrary() {
  ...
  libraryPromise = new Promise((resolve, reject) => {
    ...
    script.src = "vendor/supabase.js?v=20260827-144942";
    script.async = true;
