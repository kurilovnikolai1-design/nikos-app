...
import { el, mount, toast, openDialog, confirmDialog } from "./ui.js?v=20260827-171447";
import { initLocale, setLocale, getLocale, onLocaleChange, t, typeLabel, categoryLabel,
         statusLabel, formatDate, countOf, PLURALS } from "./i18n.js?v=20260827-171447";
import { initRouter, navigate, onNavigate, currentView, VIEWS } from "./router.js?v=20260827-171447";
...
import { refresh, recordRow } from "./render.js?v=20260827-171447";
import { openRecordForm, ensureCoinList } from "./form.js?v=20260827-171447";
import { scheduleRateRefresh } from "./main-rates.js?v=20260827-171447";
import { selfTest as safetySelfTest } from "./safety.js?v=20260827-171447";
import * as lock from "./lock.js?v=20260827-171447";
import * as persist from "./persist.js?v=20260827-171447";
import * as store from "./store.js?v=20260827-171447";
import * as records from "./records.js?v=20260827-171447";
import * as cloud from "./cloud.js?v=20260827-171447";
import * as notify from "./notify.js?v=20260827-171447";
import * as attachments from "./attachments.js?v=20260827-171447";
import * as backups from "./backups.js?v=20260827-171447";
import * as whoop from "./whoop.js?v=20260827-171447";

import { commandView, inboxView, tasksView, projectsView, openQuickAdd } from "./views/core.js?v=20260827-171447";
import { capitalView, debtsView, cashflowView, investmentsView, cryptoView } from "./views/money.js?v=20260827-171447";
import { assetsView, healthView, labsView, documentsView, peopleView, decisionsView, timelineView } from "./views/life.js?v=20260827-171447";
import { settingsView } from "./views/settings.js?v=20260827-171447";
...
async function boot() {
  ...
  /* WHOOP records every night; without this the health screen was only as
     fresh as the last time the owner pressed sync. */
  whoop.watchWhoop(() => render());
