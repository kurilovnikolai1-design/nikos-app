...
import { el, mount, toast, openDialog, confirmDialog } from "./ui.js?v=20260827-092919";
import { initLocale, setLocale, getLocale, onLocaleChange, t, typeLabel, categoryLabel,
         statusLabel, formatDate, countOf, PLURALS } from "./i18n.js?v=20260827-092919";
import { initRouter, navigate, onNavigate, currentView, VIEWS } from "./router.js?v=20260827-092919";
import { assertSchemaIsSound, TYPES } from "./schema.js?v=20260827-092919";
import { buildAttention } from "./attention.js?v=20260827-092919";
import { refresh, recordRow } from "./render.js?v=20260827-092919";
import { openRecordForm, ensureCoinList } from "./form.js?v=20260827-092919";
import { scheduleRateRefresh } from "./main-rates.js?v=20260827-092919";
import { selfTest as safetySelfTest } from "./safety.js?v=20260827-092919";
...
import * as whoop from "./whoop.js?v=20260827-092919";

import { commandView, inboxView, tasksView, projectsView, openQuickAdd } from "./views/core.js?v=20260827-092919";
import { capitalView, debtsView, cashflowView, investmentsView, cryptoView } from "./views/money.js?v=20260827-092919";
import { assetsView, healthView, labsView, documentsView, peopleView, decisionsView, timelineView } from "./views/life.js?v=20260827-092919";
import { settingsView } from "./views/settings.js?v=20260827-092919";
