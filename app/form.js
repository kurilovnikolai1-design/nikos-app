...
import { el, openDialog, toast, confirmDialog } from "./ui.js?v=20260827-100955";
import { t, getLocale, statusLabel, priorityLabel, confidenceLabel, ownerLabel, frequencyLabel, categoryLabel, typeLabel } from "./i18n.js?v=20260827-100955";
import { TYPES, typeDef, categoriesOf, statusesOf, fieldsOf, PRIORITY, CONFIDENCE, OWNER, FREQUENCY } from "./schema.js?v=20260827-100955";
import { CURRENCY_CODES, CURRENCIES, parseAmount, toMajor } from "./money.js?v=20260827-100955";
import { COINS } from "./rates.js?v=20260827-100955";
import { fieldCopy, namePlaceholder } from "./form-copy.js?v=20260827-100955";
