...
import { el, panel, panelHeader, emptyState, toast, confirmDialog, openDialog } from "../ui.js?v=20260827-130449";
import { t, getLocale, setLocale, formatDate, countOf, plural, PLURALS, typeLabel, categoryLabel } from "../i18n.js?v=20260827-130449";
import { CURRENCY_CODES, CURRENCIES, formatMoney } from "../money.js?v=20260827-130449";
import { refresh, pageHeading, recordList } from "../render.js?v=20260827-130449";
import { SOURCES, sourceLabel, isStale, COINS } from "../rates.js?v=20260827-130449";
...
import { refreshRates } from "../main-rates.js?v=20260827-130449";
import { loadDemoData, clearDemoData, countDemo, isDemoRecord } from "../demo.js?v=20260827-130449";
import { whoopRow } from "../whoop.js?v=20260827-130449";
    ...
    return panel("settings-panel",
      ...
      el("button", { class: "ghost-button", type: "button", text: ru() ? "Запустить проверку" : "Run self-test",
                     onclick: async () => {
                       ...
                       const suite = await import("../selftest.js?v=20260827-130449");
