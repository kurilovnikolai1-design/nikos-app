...
import { el, panel, panelHeader, metricCard, emptyState, toast, confirmDialog, openDialog } from "../ui.js?v=20260827-171447";
import { t, getLocale, formatDate, relativeDays, countOf, categoryLabel, statusLabel,
         plural, PLURALS, formatNumber, typeLabel, frequencyLabel } from "../i18n.js?v=20260827-171447";
import { formatMoney, formatQuantity, parseAmount, CURRENCIES } from "../money.js?v=20260827-171447";
import { netWorth, cashflow, recurringLoad, periodRange, buildSnapshot, monthlyEquivalentMinor, yearOverYear } from "../finance.js?v=20260827-171447";
import { budgetStatus, BUDGET_STATE, BUDGET_NOTE } from "../budget.js?v=20260827-171447";
import { refreshRates } from "../main-rates.js?v=20260827-171447";
import { openBankImport } from "../csv.js?v=20260827-171447";
import { goalsOverview, totalOutstanding, GOAL_STATE, GOAL_NOTE } from "../goals.js?v=20260827-171447";
import { portfolio, PNL_STATE, PNL_NOTE } from "../positions.js?v=20260827-171447";
import { QUOTES_NOTE } from "../quotes.js?v=20260827-171447";
import { cryptoUsdPrice, sourceLabel, isStale, missingRates, COINS } from "../rates.js?v=20260827-171447";
import { isVerified } from "../schema.js?v=20260827-171447";
import { recordList, addButton, pageHeading, exclusionNote, chipRow, refresh, sparkline } from "../render.js?v=20260827-171447";
