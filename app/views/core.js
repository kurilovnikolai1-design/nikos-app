...
import { el, panel, panelHeader, metricCard, emptyState, toast, openDialog } from "../ui.js?v=20260827-064144";
import { t, getLocale, formatDate, relativeDays, countOf, plural, PLURALS, categoryLabel,
         statusLabel, priorityLabel, formatNumber, typeLabel } from "../i18n.js?v=20260827-064144";
import { formatMoney } from "../money.js?v=20260827-064144";
import { netWorth, periodRange, sportSummary, inRange } from "../finance.js?v=20260827-064144";
import { buildAttention } from "../attention.js?v=20260827-064144";
import { recordList, recordRow, addButton, pageHeading, refresh, sparkline } from "../render.js?v=20260827-064144";
import { openRecordForm } from "../form.js?v=20260827-064144";
import { navigate } from "../router.js?v=20260827-064144";
...
function taskLine(task) {
  ...
  const box = el("input", {
    ...
    onchange: async () => {
      ...
      if (result.ok) { toast(ru() ? "Задача выполнена" : "Task done", { tone: "success" }); refresh(); }
    }
  });
